 ...
 * @note Call once from app_main after NVS. Shared by SoftAP HTTP and fw_ota_lte.
 ...
 *                     ota_applied via fw_ota_lte_commit_pending_applied() when true.
 */
 ...
 * @note Mutex-serialized; rejects concurrent WRITING or missing fw_ota_init().
